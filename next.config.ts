        ...
        headers: [
          {
            ...
            value: process.env.NODE_ENV === 'development' 
              ? "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://va.vercel-scripts.com https://vercel.live; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; connect-src 'self' http://localhost:* https://*.supabase.co wss://*.supabase.co https://emuski.jiobase.com https://*.jiobase.com wss://emuski.jiobase.com wss://*.jiobase.com https://vercel.live wss://ws-us3.pusher.app https://*.railway.app https://mithran-production.up.railway.app https://mithran-production-dc9d.up.railway.app; font-src 'self' 'unsafe-inline' data: blob: https://fonts.gstatic.com https://r2cdn.perplexity.ai; img-src 'self' data: blob: https: http://localhost:*; object-src 'none'; frame-src 'self' https://vercel.live https://*.vercel.live https://*.supabase.co https://emuski.jiobase.com https://*.jiobase.com http://localhost:*; base-uri 'self';"
              : "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://va.vercel-scripts.com https://vercel.live; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; connect-src 'self' https://*.supabase.co wss://*.supabase.co https://emuski.jiobase.com https://*.jiobase.com wss://emuski.jiobase.com wss://*.jiobase.com https://vercel.live wss://ws-us3.pusher.app https://*.railway.app https://mithran-production.up.railway.app https://mithran-production-dc9d.up.railway.app; font-src 'self' 'unsafe-inline' data: blob: https://fonts.gstatic.com https://r2cdn.perplexity.ai; img-src 'self' data: blob: https:; object-src 'none'; frame-src 'self' https://vercel.live https://*.vercel.live https://*.supabase.co https://emuski.jiobase.com https://*.jiobase.com; base-uri 'self';"
          }
        ]
      }
    ];
