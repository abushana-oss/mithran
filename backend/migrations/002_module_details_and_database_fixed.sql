-- ============================================================================
-- MIGRATION 002: Module Details and Database Section - FIXED
-- ============================================================================
...
-- ============================================================================
-- DATABASE SECTION - PROCESS DATABASE (THIS IS THE CRITICAL TABLE!)
-- ============================================================================
...
DROP TRIGGER IF EXISTS update_supplier_evaluations_updated_at ON supplier_evaluations;
CREATE TRIGGER update_supplier_evaluations_updated_at BEFORE UPDATE ON supplier_evaluations
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_supplier_nominations_updated_at ON supplier_nominations;
...
DROP TRIGGER IF EXISTS update_machine_hour_rates_updated_at ON machine_hour_rates;
CREATE TRIGGER update_machine_hour_rates_updated_at BEFORE UPDATE ON machine_hour_rates
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_labor_hour_rates_updated_at ON labor_hour_rates;
...
DROP TRIGGER IF EXISTS update_vendor_machines_updated_at ON vendor_machines;
...
DROP POLICY IF EXISTS "Users can view project_modules for their projects" ON project_modules;
...
DROP POLICY IF EXISTS "Users can insert project_modules for their projects" ON project_modules;
...
DROP POLICY IF EXISTS "Users can update project_modules for their projects" ON project_modules;
CREATE POLICY "Users can update project_modules for their projects"
    ON project_modules FOR UPDATE
    USING (EXISTS (SELECT 1 FROM projects WHERE projects.id = project_modules.project_id AND projects.user_id = auth.uid()));

DROP POLICY IF EXISTS "Users can delete project_modules for their projects" ON project_modules;
CREATE POLICY "Users can delete project_modules for their projects"
    ON project_modules FOR DELETE
    USING (EXISTS (SELECT 1 FROM projects WHERE projects.id = project_modules.project_id AND projects.user_id = auth.uid()));

-- Similar policies for related tables
DROP POLICY IF EXISTS "Users can view supplier_evaluations for their project modules" ON supplier_evaluations;
...
DROP POLICY IF EXISTS "Users can insert supplier_evaluations for their project modules" ON supplier_evaluations;
...
DROP POLICY IF EXISTS "Users can update supplier_evaluations for their project modules" ON supplier_evaluations;
...
DROP POLICY IF EXISTS "Users can delete supplier_evaluations for their project modules" ON supplier_evaluations;
...
DROP POLICY IF EXISTS "Users can manage supplier_nominations" ON supplier_nominations;
...
DROP POLICY IF EXISTS "Users can manage production_plans" ON production_plans;
...
DROP POLICY IF EXISTS "Users can manage their machine_hour_rates" ON machine_hour_rates;
CREATE POLICY "Users can manage their machine_hour_rates" ON machine_hour_rates FOR ALL
    USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can manage their labor_hour_rates" ON labor_hour_rates;
...
DROP POLICY IF EXISTS "Users can manage their calculators" ON calculators;
CREATE POLICY "Users can manage their calculators" ON calculators FOR ALL
    USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can manage vendor_machines for their vendors" ON vendor_machines;
