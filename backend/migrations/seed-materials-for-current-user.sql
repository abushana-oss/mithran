-- ============================================================================
-- Seed Materials Data for Current User
-- ============================================================================
-- This will insert sample materials for the currently logged-in user
...
BEGIN
    ...
    SELECT COUNT(*) INTO material_count FROM materials WHERE user_id = current_user_id;

    IF material_count > 0 THEN
        RAISE NOTICE 'User already has % materials. Skipping seed.', material_count;
        RETURN;
    END IF;

    RAISE NOTICE 'Seeding materials for user: %', current_user_id;
    ...
    RAISE NOTICE 'Successfully seeded 10 sample materials for user';
END$$;
