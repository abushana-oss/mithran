-- ============================================================================
-- Calculator: Machining - Plasma Cutting
-- Category:   Process
-- Fields:     20 (8 W/C, 2 process, 10 calculated)
-- Identical formula to Laser Cutting:
...
BEGIN
  INSERT INTO calculators (
    ...
    false,
    false,
    'Plasma cutting – machining time = length / feed rate, full cost breakdown'
  )
  ...
  RAISE NOTICE 'Done — Machining Plasma Cutting, ID: %', v_calc_id;
END $$;
