-- ============================================================================
-- Calculator: Sheet Metal - Stamping Cost Drivers
-- Category:   Process
-- Fields:     23 (9 Number inputs from linked calculators, 7 Rate inputs, 6 Calculated, 1 Number)
...
BEGIN
  INSERT INTO calculators (
    ...
    v_user_id,
    'Sheet Metal - Stamping Cost Drivers',
    'process',
    'single',
    false,
    false,
    'Stamping cost driver calculations – machine, setup, labor, inspection, yield, net process cost'
  )
  ...
  VALUES
    ...
    -- Inputs from Stamping Manufacturing calculator
  ...
  RAISE NOTICE 'Done — Sheet Metal Stamping Cost Drivers, ID: %', v_calc_id;
END $$;
