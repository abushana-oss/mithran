...
BEGIN
  INSERT INTO calculators (
    ...
    false,
    false,
    'Drilling – spindle RPM, machining time with depth approach, full cost breakdown'
  )
  ...
  RAISE NOTICE 'Done — Machining Drilling, ID: %', v_calc_id;
END $$;
