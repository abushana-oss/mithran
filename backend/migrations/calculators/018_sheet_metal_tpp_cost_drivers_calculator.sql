-- ============================================================================
-- Calculator: Sheet Metal - TPP Cost Drivers
-- Category:   Process
-- Fields:     22 (8 Number inputs from linked calculators, 7 Rate inputs, 6 Calculated, 1 Number)
-- Standard cost driver formulas (no No Of Impressions division for TPP):
...
BEGIN
  INSERT INTO calculators (
    ...
    v_user_id,
    'Sheet Metal - TPP Cost Drivers',
    'process',
    'single',
    false,
    false,
    'TPP (Turret Punch Press) cost driver calculations – machine, setup, labor, inspection, yield, net process cost'
  )
  ...
  VALUES
    ...
    -- Inputs from TPP Manufacturing calculator
  ...
  RAISE NOTICE 'Done — Sheet Metal TPP Cost Drivers, ID: %', v_calc_id;
END $$;
