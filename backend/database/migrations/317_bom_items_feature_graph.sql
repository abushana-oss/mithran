-- ARCHIVED: active version is backend/migrations/320_bom_items_feature_graph.sql
-- Migration 317 (database/migrations): Add manufacturing feature graph columns to bom_items
