...
export class ProcessCostResponseDto {
  ...
  // Auto Plan + Manual Override fields (migration 343)
  @ApiPropertyOptional({ description: 'Factory location when this route was applied (India, USA, China, ...)' })
  location?: string | null;

  @ApiProperty({ description: 'FALSE = auto-generated by engine; TRUE = manually overridden by engineer' })
  isOverride: boolean;

  @ApiPropertyOptional({ description: 'Provenance of the cycle time', example: 'feature_geometry' })
  timingSource?: string | null;

  // Machine and labour display names (already stored, exposed here for Auto display)
