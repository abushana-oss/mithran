...
export const processesGroup: ResourceGroup = {
  ...
  endpoints: [
      ...
      requestBody: {
        ...
        schema: {
          ...
          properties: [
            ...
            { name: 'lsrId', type: 'string', required: false, description: 'Default Labour Standard Rate UUID', format: 'uuid' },
    ...
    },
    {
      ...
      description: 'Returns full process details including assigned MHR, LSR, and historical cost data.',
      parameters: [
      ...
      requestBody: {
        ...
        schema: {
          ...
          properties: [
            ...
            { name: 'lsrId', type: 'string', required: false, description: 'Updated LSR UUID', format: 'uuid' },
          ],
        },
    ...
    },
    {
      ...
      description: 'Calculates the manufacturing cost for a specific process based on cycle time, machine hour rate (MHR), and labor rate (LSR).',
      parameters: [
        { name: 'id', in: 'path', type: 'string', required: true, description: 'Process UUID', format: 'uuid' },
      ],
      requestBody: {
        ...
        schema: {
          ...
          properties: [
            ...
            { name: 'lsrId', type: 'string', required: false, description: 'Override Labor Standard Rate UUID' },
          ],
        },
