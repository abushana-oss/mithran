...
export function CostCompetencyAnalysis({ nominationId, vendors = [] }: CostCompetencyAnalysisProps) {
  ...
  if (isLoadingCostData || isLoadingWeights) {
    return (
      <div className="space-y-6">
        <Card className="bg-gray-800 border-gray-700">
          <CardContent className="p-8 text-center">
            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-blue-500 mx-auto mb-4"></div>
            <h3 className="text-lg font-medium text-gray-300 mb-2">Loading Cost Analysis Data</h3>
            <p className="text-gray-400">Please wait while we load your cost competency data...</p>
          </CardContent>
        </Card>
      </div>
    );
