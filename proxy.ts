...
function addSecurityHeaders(response: NextResponse, request: NextRequest) {
  ...
  const csp = isProduction 
    ? `default-src 'self'; script-src 'self' 'unsafe-inline' https://vercel.live https://va.vercel-scripts.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' 'unsafe-inline' data: blob: https://fonts.gstatic.com https://r2cdn.perplexity.ai; img-src 'self' data: blob: https:; connect-src 'self' https://*.supabase.co wss://*.supabase.co https://emuski.jiobase.com https://*.jiobase.com wss://emuski.jiobase.com wss://*.jiobase.com https://vercel.live https://*.railway.app https://mithran-production.up.railway.app https://mithran-production-dc9d.up.railway.app; object-src 'self' data: blob: https://*.supabase.co https://emuski.jiobase.com; frame-src 'self' data: blob: https://vercel.live https://*.vercel.live https://*.supabase.co https://emuski.jiobase.com https://*.jiobase.com https://*.railway.app; media-src 'self' data: blob: https:; child-src 'self' data: blob:; base-uri 'self'; form-action 'self'`
    : `default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://va.vercel-scripts.com; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob: https:; connect-src 'self' ws://localhost:* http://localhost:* http://localhost:4000 http://localhost:5000 https://*.supabase.co wss://*.supabase.co https://emuski.jiobase.com https://*.jiobase.com wss://emuski.jiobase.com wss://*.jiobase.com https://*.railway.app; font-src 'self' 'unsafe-inline' data: blob: https://fonts.gstatic.com; frame-src 'self' data: blob: https://*.supabase.co https://emuski.jiobase.com https://*.jiobase.com; object-src 'self' data: blob: https://*.supabase.co https://emuski.jiobase.com; media-src 'self' data: blob: https:; child-src 'self' data: blob:`
