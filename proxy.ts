...
function addSecurityHeaders(response: NextResponse, request: NextRequest) {
  ...
  const csp = isProduction
    ? [
      ...
      "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://iuvtsvjpmovfymvnmqys.supabase.co wss://iuvtsvjpmovfymvnmqys.supabase.co https://vercel.live https://*.railway.app https://mithran-production.up.railway.app https://mithran-production-dc9d.up.railway.app https://router.project-osrm.org",
    ...
    : [
      ...
      "img-src 'self' data: blob: https:",
      "connect-src 'self' ws://localhost:* http://localhost:* http://localhost:4000 http://localhost:5000 https://*.supabase.co wss://*.supabase.co https://iuvtsvjpmovfymvnmqys.supabase.co wss://iuvtsvjpmovfymvnmqys.supabase.co https://*.railway.app https://router.project-osrm.org",
